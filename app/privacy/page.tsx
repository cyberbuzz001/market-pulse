    ...
    <div className="container" style={{ paddingTop: '60px', paddingBottom: '60px', maxWidth: '800px' }}>
      <div className="glass" style={{ padding: '40px' }}>
        ...
        <div className="prose">
          ...
          <p>
            At <strong>Expert's MarketPulse</strong>, the privacy of our visitors is of extreme importance to us. This document details the types of personal information collected, processed, and our compliance with financial publication rules in India.
          </p>
          ...
          <p>
            Expert's MarketPulse uses standard web server log files (IP addresses, browser type, ISP, time stamps, referring URLs) purely to analyze site performance, detect security anomalies, and ensure our automated site features load smoothly.
          </p>
          ...
          <div style={{ padding: '20px', borderLeft: '4px solid #ef4444', background: 'var(--secondary)', borderRadius: '0 8px 8px 0', marginBottom: '24px' }}>
            ...
            <p style={{ marginTop: '12px', marginBottom: 0, fontSize: '0.95rem' }}>
              Expert's MarketPulse is an automated financial reporting and simulation portal. We are NOT registered with the Securities and Exchange Board of India (SEBI) as a research analyst or investment advisor. The information provided here is for educational, analytical, and informational purposes only. It should not be construed as investment, trading, or financial advice.
            </p>
          </div>
