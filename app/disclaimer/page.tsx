      ...
      <div className="glass" style={{ padding: '40px' }}>
        ...
        <div className="prose">
          ...
          <div style={{ padding: '20px', borderLeft: '4px solid #f59e0b', background: 'var(--secondary)', borderRadius: '0 8px 8px 0', marginBottom: '24px' }}>
            <p style={{ margin: 0, fontWeight: 600, color: 'var(--foreground)' }}>IMPORTANT: The content on Expert&apos;s MarketPulse (a property of SHREESVARN FINNOVOTION PRIVATE LIMITED) is generated using artificial intelligence and automated systems.</p>
          </div>
          <p style={{ color: 'var(--text-muted)' }}>
          ...
          <p style={{ color: 'var(--text-muted)' }}>
            Under no circumstances shall Expert&apos;s MarketPulse, SHREESVARN FINNOVOTION PRIVATE LIMITED, its founders, employees, technology providers, or affiliates be liable for any direct, indirect, incidental, special, consequential, or punitive damages arising from your use of or inability to use this website, its content, or any linked third-party websites. This includes, but is not limited to, any losses, damages, or claims arising from trading or investment decisions made based on the content of this website.
          </p>

          <h2 style={{ marginTop: '32px', marginBottom: '16px', fontSize: '1.5rem' }}>Third-Party Links</h2>
          <p style={{ color: 'var(--text-muted)' }}>
            This website may contain links to external websites. Expert&apos;s MarketPulse and SHREESVARN FINNOVOTION PRIVATE LIMITED do not endorse and are not responsible for the content, accuracy, or practices of third-party websites. Accessing third-party sites is at your own risk.
          </p>

          <h2 style={{ marginTop: '32px', marginBottom: '16px', fontSize: '1.5rem' }}>Changes to This Disclaimer</h2>
          <p style={{ color: 'var(--text-muted)' }}>
            Expert&apos;s MarketPulse and SHREESVARN FINNOVOTION PRIVATE LIMITED reserve the right to modify this disclaimer at any time without prior notice. By continuing to access or use our website after any revisions become effective, you agree to be bound by the updated terms.
          </p>

          <div style={{ marginTop: '40px', padding: '20px', border: '1px solid var(--glass-border)', borderRadius: '12px', textAlign: 'center' }}>
            <p style={{ margin: 0, fontSize: '0.9rem', color: 'var(--text-muted)' }}>
              By using Expert&apos;s MarketPulse, you acknowledge that you have read, understood, and agree to be bound by this Disclaimer and our Terms of Use, including those set forth by SHREESVARN FINNOVOTION PRIVATE LIMITED.
            </p>
          </div>
        </div>
      </div>
